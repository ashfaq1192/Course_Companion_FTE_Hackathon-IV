...
**Storage**: Cloudflare R2 (static course content only - no processing), PostgreSQL-compatible (Neon/Supabase for progress/data)
...
- [x] Zero-Backend-LLM Architecture: No LLM calls in backend during Phase 1
...
- [x] Dual-Frontend Architecture: Separate codebases for ChatGPT App and Web App
- [x] Hybrid Intelligence Justification: If Phase 2 features added, properly scoped and justified
- [x] Agent Skills-First Design: Educational functionality through SKILL.md files
