...
class HybridIntelligenceService:
    ...
    def generate_adaptive_learning_path(
        ...
        context = {
            "user_progress": [p.__dict__ for p in user_progress],
            "quiz_performance": [qa.__dict__ for qa in quiz_attempts],
        ...
        try:
            llm_response = self.llm_client.generate_completion(prompt, max_tokens=1000)
    ...
    def grade_assessment_with_llm(
        ...
        grading_context = {
            ...
            "quiz_attempt": quiz_attempt.__dict__ if quiz_attempt else {}
        }
        ...
        try:
            llm_response = self.llm_client.generate_completion(prompt, max_tokens=800)
